...
switch ($loop_sidebar_position) {
    case 'sidebar_left':
        ...
        <div class="span8 column_container">
            ...
            <h1 itemprop="name" class="entry-title td-page-title">
                <?php /*<a itemprop="url" href="<?php echo get_tag_link(get_query_var('tag_id'));?>" rel="bookmark" title="<?php echo __td('Posts in ') . $current_tag_name?>">标签: <?php echo $current_tag_name ?></a>*/?>
                <span><?php echo __td('标签');?>: <?php echo $current_tag_name ?></span>
            </h1>
    ...
    case 'no_sidebar':
        ...
        <div class="span12 column_container">
            ...
            <h1 itemprop="name" class="entry-title td-page-title">
                <?php /*<a itemprop="url" href="<?php echo get_tag_link(get_query_var('tag_id'));?>" rel="bookmark" title="<?php echo __td('发表在 ') . $current_tag_name?>"><?php echo $current_tag_name ?></a>*/?>
