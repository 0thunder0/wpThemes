...
vc_map( array(
  ...
  "params" => array(
    ...
    array(
      ...
      "value" => array(__("Display post date?", 'td') => true )
    ),
    array(
      "type" => "textfield",
      "heading" => __("Extra class name", "js_composer"),
