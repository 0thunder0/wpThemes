            ...
            <div class="span4 header-logo-wrap" role="banner" itemscope="itemscope" itemtype="http://schema.org/Organization">
                ...
                if (!empty($td_customLogoR)) {
                    ...
                    <a itemprop="url" href="<?php echo home_url(); ?>">
                        <img width="300" class="td-retina-data" itemprop="logo" data-retina="<?php echo htmlentities($td_customLogoR) ?>" src="<?php echo $td_customLogo?>" alt="<?php echo $td_logo_alt ?>"<?php echo $td_logo_title ?>/>
                    </a>
                    ...
                    if (!empty($td_customLogo)) {
                        ?>
                        <a itemprop="url" href="<?php echo home_url(); ?>"><img width="300" itemprop="logo" src="<?php echo $td_customLogo?>" alt="<?php echo $td_logo_alt ?>"<?php echo $td_logo_title ?>/></a>
                        <meta itemprop="name" content="<?php bloginfo('name')?>">
                        <?php
                    }
                }
