...
define("TD_THEME_DOC_URL", "http://import.tagdiv.com/" . strtolower(TD_THEME_NAME) . "/doc");
...
switch (TD_DEPLOY_MODE) {
    case 'dev':
        ...
        define("TD_DEPLOY_READ_CONTENT_META", true); //load customizations based on pageslugs (used in demo)
    ...
    default:
        ...
        define("TD_DEPLOY_READ_CONTENT_META", false);
